                ...
                <tbody>   
                    {
                        users.map((res, index) => {
                            return (<tr key={index}>
                                ...
                                <td>{res.city}</td>
                                <td>{res.phone}</td>
                                <td> <Link to={`${props.match.path}/hookview/${res.id}`} className="btn btn-primary text-white">View</Link></td>
                                <td> <Link to={`${props.match.path}/hooksedit/${res.id}`} className="btn btn-info text-white">Edit</Link></td>
